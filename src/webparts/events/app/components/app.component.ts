...
@Component({
  ...
  <table class="${styles.table}">
      ...
      <tr>
          <td><input type="text" id="txtFirstName" [(ngModel)]="newAttendeeFirstName" /></td>
...
export class AppComponent implements OnInit {
  ...
  public newAttendeeFirstName: string = '';
  ...
  private AddAttendee() {
    ...
    let event: IEvent = {
      ID: 0,
      FirstName: that.newAttendeeFirstName,
  ...
  private PrepUpdateAttendee(att: IEvent) {
    ...
    this.newAttendeeFirstName = att.FirstName;
